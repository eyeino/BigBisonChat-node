...
const findConversationsByUserIdIR: any = {
  ...
  params: [
    {
      ...
      codeRefs: {
        used: [
          { a: 121, b: 126, line: 3, col: 54 },
          { a: 155, b: 160, line: 3, col: 88 },
        ],
      },
    },
  ],
 ...
 * ```
 */
export const findConversationsByUserId = new PreparedQuery<
  IFindConversationsByUserIdParams,
  IFindConversationsByUserIdResult
>(findConversationsByUserIdIR);
