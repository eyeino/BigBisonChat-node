  ...
  params: [
    {
      ...
      codeRefs: {
        used: [
          { a: 117, b: 125, line: 5, col: 33 },
          { a: 185, b: 193, line: 6, col: 27 },
        ],
      },
    },
    {
      ...
      codeRefs: {
        used: [
          { a: 150, b: 155, line: 5, col: 66 },
          { a: 221, b: 226, line: 6, col: 63 },
        ],
      },
    },
    {
      name: 'offset',
      transform: { type: 'scalar' },
      codeRefs: { used: [{ a: 275, b: 280, line: 7, col: 46 }] },
    },
  ],
  usedParamSet: { recipient: true, sender: true, offset: true },
  statement: {
    body:
 ...
 * ```
 */
export const findConversation = new PreparedQuery<
  IFindConversationParams,
  IFindConversationResult
>(findConversationIR);
